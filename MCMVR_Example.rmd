...
In this document, we provide a short tutorial on how to use the $\texttt{MCMVR}$ R package. **If you encounter any errors or strange behavior, please report the issue at <github.com/ajmolstad/MCMVR>.** We download this package from GitHub. 
